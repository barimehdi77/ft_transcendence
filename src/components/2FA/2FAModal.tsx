		...
		<section className='m-0 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 '>
			<div className='drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] mt-20'>
				...
				<div className='bg-white px-10 py-4 rounded-b-3xl flex flex-col'>
					...
					<button
						onClick={sendCode}
						className='bg-sky-800 px-6 py-2 w-min m-auto text-l text-white font-semibold capitalize rounded-full drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] hover:bg-sky-700 hover:scale-105'
					>
						submit
					</button>
				</div>
