...
const ProfileHeader = ({ profileData, setProfileData }: any) => {
	...
	if (points < 10) rank = 'text-yellow-700';
	else if (points > 10 && points < 20) rank = 'text-slate-300';
	else if (points > 29) rank = 'text-yellow-500';
	...
	return (
		<div className='bg-sky-800 px-10 py-4 rounded-t-3xl	'>
			<div className='flex items-center'>
				...
				<UserImage image_url={profileData.image_url} status={profileData.profile.status} />
			</div>
